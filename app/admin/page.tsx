...
import { getBranches, getAllDepartmentsForOrg } from "@/lib/firebase/organizations"
...
export default function AdminDashboard() {
  ...
  const plan = getPlanDetails(organization?.plan || "free")
  const usagePercentage = Math.min(100, (stats.totalUsers / plan.userLimit) * 100)
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          <Card className="dark:bg-slate-800/50 dark:border-slate-700 shadow-premium border-l-4 border-l-purple-500">
