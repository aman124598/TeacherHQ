...
import { AlertCircle, School, Mail, Lock, Eye, EyeOff, User, Building, IdCard } from "lucide-react"
      ...
      <Card className="w-full max-w-lg shadow-premium border-0 dark:border dark:border-slate-700 animate-fade-in backdrop-blur-sm bg-white/95 dark:bg-slate-800/95 relative z-10">
        ...
        <CardContent className="pb-4">
          <form onSubmit={handleSignUp} className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                <label htmlFor="teacherId" className="text-sm font-semibold text-gray-700 dark:text-gray-200">
                  Teacher ID
                </label>
                <div className="relative">
            ...
            <div className="space-y-2">
              <label htmlFor="department" className="text-sm font-semibold text-gray-700 dark:text-gray-200">
                Department
              </label>
              <div className="relative">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    placeholder="••••••••"
                    required
                    className="h-11 pl-10 pr-10 border-gray-200 dark:border-slate-600 focus:border-purple-500 dark:focus:border-purple-400 transition-all duration-200"
                  />
                  <button
                    type="button"
        ...
        <CardFooter className="flex flex-col space-y-3 pb-6">
          <div className="text-center text-sm">
            ...
            <Link href="/" className="text-purple-600 hover:text-purple-700 dark:text-purple-400 dark:hover:text-purple-300 font-semibold">
              Sign in
            </Link>
          </div>
        </CardFooter>
